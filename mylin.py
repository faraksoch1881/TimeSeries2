...
# -----------------------------------------------------------------------------
    ...
    axes[mynum].plot(year, ts, 'k.')
    axes[mynum].plot(year,Li, 'r.')
    ...
    axes[mynum].text(0.5, 0.9, 'Site velocity: '+ str_bL + '$\pm$' + str_b95CI+' mm/year', ha='center', va='center',transform=axes[mynum].transAxes,backgroundcolor='1',alpha=1)
